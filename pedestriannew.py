...
def detect_pedestrians(image ,count):
    ...
    cascade = cv2.CascadeClassifier('ped.xml')  # extracting the cascade features using Haar classifiers...
    features = cascade.detectMultiScale(gray_image, scaleFactor=2, minNeighbors=15, minSize=(26, 74),
                                        maxSize=(70, 174))
